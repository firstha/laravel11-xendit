...
<body class="bg-body-tertiary"> <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
        ...
        <main>
            ...
            <div class="row g-5">
                ...
                <input type="hidden" id="id" name="id" value="{{ $id }}" required>
                            <div class="col-sm-6"> <label for="name" class="form-label">Name</label> <input
                                    type="text" class="form-control" id="name" name="name" placeholder="your name" required>
                            </div>
