                        ...
                        <div class="col">
                            <div class="card shadow-sm">
                                <img aria-label="Placeholder: Thumbnail" class="bd-placeholder-img card-img-top"
                                    height="225" src="{{ $product->image }}">
                                <div class="card-body">
                                    <h5 class="card-title">{{ $product->name }}</h5>
                                    <p class="card-subtitle mb-2 text-muted">Rp. {{ $product->price }}</p>
                                    <p class="card-text">{{ $product->description }}</p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <a href="{{ route('detail-product',["id"=>$product->id]) }}"><button type="button" class="btn btn-primary">Buy</button>
                                        </a>
                                        </div>
                                    </div>
                                </div>
